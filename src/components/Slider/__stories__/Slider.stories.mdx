...
import { createComponentTemplate, Link, UsageGuidelines, VerticalStories } from "vibe-storybook-components";
import {
  PROGRESS_BAR,
  TOGGLE,
  WIZARD
...
import OnChangeBugStory from "./onChangeBugStory";
...
### Sergey this one's for you ❤️

This is a bug reproduction
